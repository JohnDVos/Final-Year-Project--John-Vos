                    ...
                    if ($pwdCheck == false) {                                                           //if they don't match, error message.
                      ...
                      exit();
                        ...
                        */
                        ...
                        $_SESSION['phoneNumber'] = $row['PTphoneNumb'];  
                        $_SESSION['qualificationTitle'] = $row['qualificationTitle'];  
                        $_SESSION['qualificationLevel'] = $row['qualificationLevel']; 
                        $_SESSION['insuranceCompany'] = $row['insuranceCompany']; 
                        $_SESSION['insuranceStartDate'] = $row['insuranceStartDate']; 
                        $_SESSION['insuranceEndDate'] = $row['insuranceEndDate']; 
                        $_SESSION['insuranceLevel'] = $row['insuranceLevel']; 
                        $_SESSION['pricingHour'] = $row['pricingHour']; 
                        $_SESSION['pricingPack5'] = $row['pricingPack5']; 
                        $_SESSION['pricingPack10'] = $row['pricingPack10']; 
                        $_SESSION['pricingPack20'] = $row['pricingPack20']; 
                        $_SESSION['pricingContest'] = $row['pricingContest']; 
                        $_SESSION['trainingStylePrimary'] = $row['trainingStylePrimary'];
                        $_SESSION['trainingStyleSecondary'] = $row['trainingStyleSecondary'];
                        $_SESSION['trainingStyleTertiary'] = $row['trainingStyleTertiary'];
