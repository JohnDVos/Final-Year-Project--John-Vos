...
<main>
    ...
    <button onclick="topFunction()" id="myBtn" title="Go to top">Back to top</button>    
        ...
        <ul>
            ...
            <li><a href="documents/BodyBuilding.pdf" download>Bodybuilding pdf document:</a></li>
        ...
        <ul>
            ...
            <div class="wrapper-main">
              ...
              <p>This training block is great for when you have an imbalance and it needs fixing; this particular program aims at bringing up shoulder muscle as the lagging body part and how to improve with extra focus on one muscle group. This can easily be taken and applied to any body part; for example, if your arms are a lagging body part simply replace shoulder exercises with arm exercises.</p>
            ...
            <div class="wrapper-main">  
              ...
              <p>This is a continuation and different version of the volume training approach to bodybuidling and if you have been running the previous version and enjoyed it this is a great follow up. Moreover this block focuses on hitting the muscles with lots of sets and reps rather than heavy weight at low rep ranges to get as much blood into the muscle as possible.</p>
            ...
            <div class="wrapper-main">  
              ...
              <p>This training block aims to hit as many muscle groups as possible as often as possible with as much volume as possible, this block can be used by a begginer but I would recommend other blocks first..</p>
            ...
            <div class="wrapper-main">
              ...
              <p>Much like the introduction block in bodybuilding this block aims to prepare the body for training in the gym and focuses on the fundamentals, this is also great however for those more advanced lifters looking to polish their basics and deload from heavy weight or overload.</p>
            ...
            <div class="wrapper-main">  
              ...
              <p>Much like a volume approach just in the bodybuilding section, this volume approach takes into account strength training and the high volume of bodybuilding to maximise both aspects of this training style.</p>
        ...
        <div class="wrapper-main">
            <header>
                ...
                <form name="repMaxCalculator" method="post">
                    <p>
                        <label>Weight:</label>
                        <input type="text" name="weightInput" id="weightInput" placeholder="0">
                    </p>
                    <p>
                       <label>REPS</label>
                        <input type="text" name="repInput" id="repInput" placeholder="0"> 
                    </p>    
                     <input onclick=repCalc() type=button value=Calculate>
                    <p>
                        <label>1 rep max:</label>
                        <input name="repMaxTotal" id="repMaxTotal">
                    </p>
                </form>
        </div>
        ...
        <div class="wrapper-main">
            <header>
                <h2>Create your own training program:</h2>
            </header>
            <p>When it comes to creating your own training program it can be rather daunting of how to approach your goal and how to tackle exercise and all the options out there, this section aims to help educate you in your decision making process.</p>
            <header>
                <h4>Things to take into consideration:</h4>
            </header>
            <ul>
                <li>How many days a week are you trying, but more importantly how many days a week can you realiscally achieve. If you are a begginer realistically going to the gym 6 days a week going all out is not the best approach, especially in the long run.</li>
                <li>What are the main areas you want to improve on? It could be cardio, a specific lift(s) or just a general get fit. Factors those into the order you train. For example if you want to improve your squat, bench press, deadlift, pull ups, push ups break those up.</li>
                <li>You will also need to take into consideration how long each body part takes to recover.</li>
            </ul>
        </div>
</main>
