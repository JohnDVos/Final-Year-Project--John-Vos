...
<!-- HTML -->
    <main>
        ...
        <p>The most accurate method I have found to use MyFitnessPal and it's goal tracking features is to set realistic and feasable goals that are within reach. This starts with setting a goal weight and a weekly goal of weight to lose or gain. Losing or gaining 1 kg a week might seem like a great thing but take into consideration the deficit or surplus this requires and effort. Moreover, ensure your activity level and macros are set up accurately.</p>
        
        <header>
            <h3>Creating recipes:</h3>
        </header>
        <p>Creating a recipe is a fantastic way of tracking meals that are more complex than chicken, rice and brocoli and this is where using recipes can make your life infinetly easier. To create a recipe simply navigate to your daily log and click recipes new, then log each ingredient and it's weight and how many portions / servings these recipes for future use.</p>
