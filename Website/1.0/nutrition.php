...
<!-- TDEE script -->
    <script>
        function TDEECalc() {
            a = document.getElementById("BMRInput").value;
            b = document.getElementById("activityLevel").value;
            c = a*b
            d = c*0.8
            e = Math.round(c, 1)
            f = Math.round(d, 1)
            document.TDEEForm.maintananceTotal.value = e
            document.TDEEForm.weightLossCalories.value = f
        }
    </script>
...
<!-- BMR script -->
    <script>
        function BMRCalc() {
            a = document.getElementById("weightInput").value;
            b = document.getElementById("heightInput").value;
            c = document.getElementById("ageInput").value;
            d = 66 + (13.7*a) + (5*b) - (6.8*c)
            document.BMRCalculator.BMRTotal.value = d;
        }
    </script>
      ...
      <div class="wrapper-main">
          ...
          <section class="section-default">
            ...
            <header><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
              ...
              <h3>
                <header>UK National Food Guidelines:</header>
              </h3>
              ...
              <form name="BMRCalculator" method="post">
                  <fieldset>
                      ...
                      <p>
                          <label>Input your weight here:</label>
                          <input name="weightInput" id="weightInput">
                      </p>
                      <p>
                          <label>Input your height here:</label>
              ...
              <!----------- TDEE Calculator ----------->
                <form name="TDEEForm" method="post">
                    <fieldset>
                        ...
                        <p>
                            <lable>Input your BMR here:</lable>
              ...
              <header><h3>Pre-Work Out:</h3></header>
              
              <header><h3>Creatine:</h3></header>
              
              <header><h3>Vitamins:</h3></header>
              <table border="5">
                  <tr>
                      <th>Vitamin:</th>
                      <th>Functions:</th>
              ...
              --------------------------------------------------------------------->
               <a name="MyFitnessPal"></a>
              <header><h2>MyFitnessPal:</h2></header>
